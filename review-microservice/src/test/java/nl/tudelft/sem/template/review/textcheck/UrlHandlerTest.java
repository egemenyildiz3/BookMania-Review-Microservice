...
public class UrlHandlerTest {
    ...
    @BeforeEach
    public void setup() {
        urlHandler =  mock(UrlHandler.class);
    ...
    void handleTextInvalid() {
        Review review = new Review(1L, 2L, 10L,  "Review",  "http://",  5L);

        assertThrows(CustomBadRequestException.class,  () -> service.handleText(review.getText()));
        assertFalse(urlHandler.handle(review.getText()));
    }
}
